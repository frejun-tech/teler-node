...
describe("TrunkResourceManager (unit)", () => {
  ...
  describe("create", () => {
    ...
    it("propagates errors from the http layer", async () => {
      ...
      await expect(
        trunks.create(createSipTrunkPayloadFixture())
  ...
  describe("retrieve", () => {
    ...
    it("propagates errors from the http layer", async () => {
      ...
      await expect(
        trunks.retrieve("st_01J5ABCDEFGHJKMNPQRSTVWXYZ")
      ).rejects.toThrow("Network error");
    });
  });
  ...
  describe("delete", () => {
    ...
    it("propagates errors from the http layer", async () => {
      ...
      await expect(
        trunks.delete("st_01J5ABCDEFGHJKMNPQRSTVWXYZ")
      ).rejects.toThrow("Network error");
    });
  });
  ...
  describe("listVirtualNumbers", () => {
    it("gets the correct sub-resource path with no params", async () => {
      ...
      const result = await trunks.listVirtualNumbers(
        "st_01J5ABCDEFGHJKMNPQRSTVWXYZ"
      );
