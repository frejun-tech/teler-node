...
describe('SecretResourceManager (unit)', () => {
  ...
  describe('create', () => {
    ...
    it('propagates errors from the http layer', async () => {
      ...
      await expect(secrets.create(createSecretPayloadFixture())).rejects.toThrow('Network error');
    });
  });
  ...
  describe('retrieve', () => {
    ...
    it('propagates errors from the http layer', async () => {
      ...
      await expect(secrets.retrieve('sk_01J5ABCDEFGHJKMNPQRSTVWXYZ')).rejects.toThrow(
        'Network error'
      );
    });
  });
  ...
  describe('update', () => {
    it('patches the correct path with the update payload', async () => {
      ...
      const result = await secrets.update('sk_01J5ABCDEFGHJKMNPQRSTVWXYZ', payload);
    ...
    it('returns the response object reference unchanged', async () => {
      ...
      const result = await secrets.update('sk_01J5ABCDEFGHJKMNPQRSTVWXYZ', updateSecretPayloadFixture());
    ...
    it('propagates errors from the http layer', async () => {
      ...
      await expect(
        secrets.update('sk_01J5ABCDEFGHJKMNPQRSTVWXYZ', updateSecretPayloadFixture())
  ...
  describe('delete', () => {
    it('deletes the correct path for a given secret id', async () => {
      const response = { success: true, message: 'Secret deleted successfully.' };
