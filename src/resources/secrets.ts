...
export class SecretResourceManager {
    ...
    public async create(payload: CreateSecretPayload): Promise<SecretResponse> {
        return this.http.post<SecretResponse, CreateSecretPayload>(this.basePath, payload);
    }
     ...
     */
    public async update(secretId: string, payload: UpdateSecretPayload): Promise<SecretResponse> {
        return this.http.patch<SecretResponse, UpdateSecretPayload>(`${this.basePath}/${secretId}`, payload);
    }
