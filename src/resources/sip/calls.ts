...
export class SipCallResourceManager {
     ...
     */
    public async list(filters?: SipCallFilters): Promise<CursorResponse<SipCallResponse>> {
        return this.http.get<CursorResponse<SipCallResponse>, SipCallFilters>(this.basePath, filters);
    }
