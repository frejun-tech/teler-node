...
import type { CreateIpAclPayload, IpAclFilters, IpAclListResponse, IpAclResponse, UpdateIpAclPayload } from "../../types/sip";
...
export class IpAclResourceManager {
    ...
    public async create(payload: CreateIpAclPayload): Promise<IpAclResponse> {
        return this.http.post<IpAclResponse, CreateIpAclPayload>(`${this.basePath}`, payload);
    }
     ...
     */
    public async list(filters?: IpAclFilters): Promise<CursorResponse<IpAclListResponse>> {
        return this.http.get<CursorResponse<IpAclListResponse>, IpAclFilters>(this.basePath, filters);
    }
     ...
     * @returns Details of the IP access control lists.
     */
    public async update(ipAclId: string, payload: UpdateIpAclPayload): Promise<IpAclResponse> {
        return this.http.patch<IpAclResponse, UpdateIpAclPayload>(`${this.basePath}/${ipAclId}`, payload);
    }
